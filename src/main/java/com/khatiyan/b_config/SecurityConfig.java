    ...
    public SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/property-board/me/items").hasRole("USER")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/payments/checkout/{paymentOrderId}").permitAll()
